...
function SignUpModal() {
    ...
    return (<div className='ModalTest absolute flex justify-center items-center h-screen w-screen z-30 overflow-visible border'>
        ...
        <div className='md:w-1/4 w-full m-5 md:m-0 bg bg-white h-auto rounded-lg shadow-lg '
            ...
            <form className=' w-[90%] m-5  '
                onClick={handleSubmit}>
                <label htmlFor="username" className=' '>Full Name :
                </label><br/>
                <input type="text" name='userName' className='border border-black w-full my-3 h-10 rounded-lg' placeholder='Enter your full name ..'
                ...
                <input type="text" name='email' className='border  border-black w-full my-3 h-10 rounded-lg' placeholder='Enter your Eamil ..'
                    value={
                        signupData.email
                    }
                    onChange={handleFormImput}/>
                ...
                <input type="text" name='mobileNummber' className='border border-black w-full my-3 h-10 rounded-lg' placeholder='Enter Your Mobile Number '
                    onChange={handleFormImput}
                    value={
                        signupData.mobileNummber
                    }/>
                ...
                <br/>
                <input type="text" name='repeatPassword' className='border  border-black w-full my-3 h-10 rounded-lg' placeholder='Repeat your Password ..'
                    onChange={handleFormImput}
                    value={
                        signupData.repeatPassword
                    }/>
                <br/> {
                passMisMatch && <label htmlFor="username" className='text-red-700 font-normal '>password mismatch
                </label>
            }
                {
