...
{/* left box start  */}
<div className=' w-1/5 h-1/2 bg-blue-700  ' >
...
{/* center box start */}
<div className='justify-self-center items-center w-[50%] h-1/2 p-14  block bg-blue-700'>
...
“Rrow itself, let it be sorrow; let him love i
</div>
{/* center box end */}
